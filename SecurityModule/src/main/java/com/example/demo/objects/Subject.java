...
public class Subject {
    ...
    public Subject(UUID id, String name, Integer year, Integer semester, Integer credits, Integer idLectures, Integer idSeminars, java.util.Date createdAt, java.util.Date updatedAt) {
        this.id = id;
        this.name = name;
        this.year = year;
