    ...
    CommandLineRunner commandLineRunner(SubjectRepo repository) {
        return args -> {
            ...
            Subject subject4 = new Subject(4, "Introduction to Cryptography", 4, 2, 2, "description",
                    List.of(new Component(3, "Seminar", 14, List.of(new Resource(3, "Course's slides", "https://www.flt-info.eu/course/crypto/")))),
                    new ArrayList<>());
            Subject subject5 = new Subject(5, "Introduction to Computer Science", 5, 2, 2, "description",
                    List.of(new Component(4, "Course", 10, List.of(new Resource(4, "Laboratory", "https://profs.info.uaic.ro/~introp/curs2022-2023/")))),
                    new ArrayList<>());
