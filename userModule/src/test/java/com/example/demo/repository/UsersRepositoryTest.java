...
class UsersRepositoryTest {
    ...
    void CheckIfEmailExists() {
        ...
        List<User> result = usersRepository.findUserByParams(null, null, null, email, null);
    ...
    void checkIfUsernameExists() {
        ...
        List<User> result = usersRepository.findUserByParams(null, null, null, null, username);
